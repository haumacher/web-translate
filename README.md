...
|--------|-------------|------------|----------|
| auto-translate | Core translation library | Maven/Gradle | `auto-translate-1.0.2.jar` |
| auto-translate-maven-plugin | Maven plugin for HTML & ARB | Maven | `auto-translate-maven-plugin-1.0.2.jar` |
